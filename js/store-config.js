(() => {
  ...
  function applyStoreConfig() {
    document.querySelectorAll("[data-whatsapp-link]").forEach((link) => {
      const message = link.dataset.whatsappMessage || "Hola, quiero hacer una consulta a Piedra, Papel o Tijera Librería.";
      link.setAttribute("href", `https://wa.me/${storeConfig.whatsappNumber}?text=${encodeURIComponent(message)}`);
